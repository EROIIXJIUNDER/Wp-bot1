...
const defaultOwner = '9779811839489';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '9779767966426' ; // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '9779811839489' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'tKlTmS5Y#xN2C8FXKpJFHM5IoLhKgXAPxjaRP0hYlTxRjIjunaS0' ;  // put your session id here
